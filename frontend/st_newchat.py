...
if user_input := st.chat_input(
  ...
  #  disabled=st.session_state.awaiting_user,
    ...
    st.session_state.convo_history.append({"role": "user", "content": display_text, "image": user_input['img_b64']})

    with st.chat_message("assistant"):
        spinner_gif_path = "frontend/images/spinner.gif"  # Make sure this file exists
